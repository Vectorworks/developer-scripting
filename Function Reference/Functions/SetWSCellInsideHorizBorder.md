...
## Examples
```pascal
SetWSCellInsideHorizBorder(worksheet, 1, 2, 3, 10, 5, 1, 2);
```
```python
import vs

# Set inside horizontal borders with the specified attributes in specified
# worksheet cells.
...
vs.SetWSCellInsideHorizBorder(worksheet, topRow, leftColumn, bottomRow, rightColumn, style, weight, color)
```
