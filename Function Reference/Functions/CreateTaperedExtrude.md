...
## Remarks
*_c_*, (2016.02.10):  This always fails creating a number of NURBS instead of a tapered extrude. From VW 2016 you can use [CreateTaperedExtrd2](CreateTaperedExtrd2.md).
