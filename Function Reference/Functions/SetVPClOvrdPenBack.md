...
## Examples
```pascal
SetVPClOvrdPenBack(viewportHandle, 'Wall', 1, 2, 3);
```
```python
import vs

# Sets the pen background color of a class override in a viewport.
...
vs.SetVPClOvrdPenBack(viewportHandle, className, colorRV, colorGV, colorBV)
```
