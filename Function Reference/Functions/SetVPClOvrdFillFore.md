...
## Examples
```pascal
SetVPClOvrdFillFore(viewportHandle, 'Wall', 1, 2, 3);
```
```python
import vs

# Sets the fill foreground color of a class override in a viewport.
...
vs.SetVPClOvrdFillFore(viewportHandle, className, colorRV, colorGV, colorBV)
```
